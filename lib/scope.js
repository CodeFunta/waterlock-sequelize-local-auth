...
function generateScope(scopeKey, engine) {
    return {
        ...
        registerUserAuthObject: function (attributes, req, cb, mapUserCriteria,userdefaults) {
            var self = this;
            var attr = {
            ...
            return self.engine.findOrCreateAuth(criteria, attr, cb,mapUserCriteria,userdefaults);
